 ...
 * one visibly ahead of the other. Slow enough to photograph, quick enough that
 * a full capture run is seconds.
 */
const PACE_MS: Record<Variant, number> = { alpha: 90, beta: 140 };
